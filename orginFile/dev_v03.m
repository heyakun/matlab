...
F1 = H_F1M*[0 0 0 1]';
F1_s = point_by_axiosY_array(F1,n);
for j=1:n
...
for j=1:n
    if(j == 1)
        p2p_connect(A1_s{j},F1_s{n})
        p2p_connect(A1_s{j},F1_s{j})
        p2p_connect(A1_s{j},O0_s{n})
...
special_start(O1_s,F1_s,A1_s,n)
...
f =matlabFunction(E1(3)*tan(pi/n)-E1(1));
...
E1 = E1M*[0 0 2*a 1]';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
E1_s = point_by_axiosY_array(E1,n);
special_end(E1_s,O1_s,F1_s,n)
...
special_start(D1_s,E1_s,O1_s,n)
